...
PKG_SOURCE_URL:=https://github.com/kongfl888/minieap.git
PKG_SOURCE_SUBDIR:=$(PKG_NAME)-$(PKG_VERSION)
PKG_SOURCE_VERSION:=950bc8f589850f95990bcf1272078512165cb2b3
...
define Package/$(PKG_NAME)
	...
	URL:=https://github.com/kongfl888/minieap
endef
